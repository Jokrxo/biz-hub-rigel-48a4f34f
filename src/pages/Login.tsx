...
export default function Login() {
  ...
  return (
    <>
      <SEO title="Login | SA Finance Manager" description="Secure login to SA Finance Manager dashboard" canonical={window.location.href} />
      <main className="min-h-screen bg-gradient-subtle flex items-center justify-center p-6">
        <article className="w-full max-w-md rounded-lg border border-border bg-card shadow-sm p-6">
          <header className="mb-6 text-center">
            <h1 className="text-2xl font-semibold">Login to SA Finance Manager</h1>
            <p className="text-sm text-muted-foreground mt-1">Professional accounting for South African businesses</p>
          </header>
