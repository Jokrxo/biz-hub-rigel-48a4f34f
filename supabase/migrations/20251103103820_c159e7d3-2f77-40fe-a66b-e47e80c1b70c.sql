-- Fix RLS violation in bank account opening balance trigger
-- The function needs to bypass RLS when creating opening balance transactions
...
CREATE TRIGGER on_bank_account_insert
